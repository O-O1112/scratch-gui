...
const isValidTheme = theme => [DEFAULT_THEME, DARK_THEME, HIGH_CONTRAST_THEME].includes(theme);
...
const systemPreferencesTheme = () => {
    ...
    if (window.matchMedia && window.matchMedia(PREFERS_DARK_QUERY).matches) return DARK_THEME;
